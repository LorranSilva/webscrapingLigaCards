...
class LigapokeSpider(scrapy.Spider):
    name = 'ligapoke'
    allowed_domains = ['www.ligapokemon.com.br']
    start_urls = ['https://www.ligapokemon.com.br/?view=cards/home']


    def parse(self, response):
        collection_names = response.css('.edc-nm-2')
