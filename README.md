...
mas o fator principal foi entender que havia uma renderização dinâmica. Para isto o js foi desativado no navegsdor,
indo ao DevTools do navegador, ctrl+shit+p (Windows, Linux) e digitando "javascript", a opção de "disable" se mostra
e ao desabilitar o js é só dar um refresh.
Alguns elementos da página estão sendo renderizados de modo dinâmico é necessário outra abordagem.
Para contornar isto foi necessário utilizar ScrapySplash.</p>
<br>
